...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "wtqtmnwh3nmjtoz3"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//水泵速度(可下发可上报)
//备注:
#define DPID_WATER_PRESS 104
//控温上限(可下发可上报)
//备注:
#define DPID_TEM_UP 105
